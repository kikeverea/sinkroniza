...
class FoldersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create folder" do
    assert_difference("Folder.count") do
      post folders_url, params: { folder: { company_id: @folder.company_id, name: @folder.name, parent_folder_id: @folder.parent_folder_id } }
    end
  ...
  test "should update folder" do
    patch folder_url(@folder), params: { folder: { company_id: @folder.company_id, name: @folder.name, parent_folder_id: @folder.parent_folder_id } }
