$(function(){$('[data-toggle="tooltip"]').tooltip()}),$(document).on('turbolinks:load', function() {console.log("readyturbo");jQuery(".scrollbar-inner").scrollbar()}),$(document).ready(function(){var t=!1,o=!1,e=0,a=0
